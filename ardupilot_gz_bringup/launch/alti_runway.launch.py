...
"""Launch the Alti Quadplane in Gazebo and Rviz."""
...
def generate_launch_description():
    """Generate a launch description for a alti quadplane."""
    ...
    gz_sim_server = IncludeLaunchDescription(
        ...
        launch_arguments={
            "gz_args": "-v4 -s -r "
            f'{Path(pkg_project_gazebo) / "worlds" / "alti_runway.sdf"}'
        }.items(),
    )
